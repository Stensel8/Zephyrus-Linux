...
{{% details title="Looking Glass B7: GPU passthrough on the Zephyrus G16" closed="true" %}}
...
{{% details title="YubiKey 5C NFC: FIDO2 LUKS unlock" closed="true" %}}

I wanted to unlock the LUKS-encrypted drive at boot by plugging in the YubiKey and touching it. This documents the attempt and why it didn't work. The YubiKey works fine for everything outside of early boot; see the [YubiKey]({{< relref "/docs/security/yubikey" >}}) page for the pam-u2f setup.
