...
Messages.cat_dir_exists = "Directory {} exists; some of its files may " \
    "be overwritten"
Config.instname = "Saxion University of Applied Sciences"
Config.profilename = "eduroam Saxion"
Config.url = "https://servicedesk.saxion.nl"
Config.email = "your local eduroam® support"
Config.title = "eduroam CAT"
Config.server_match = "ise.infra.saxion.net"
...
Config.user_realm = "saxion.nl"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:ise.infra.saxion.net']
